...
<section class="pt-32 pb-20 px-6">
    <div class="max-w-4xl mx-auto bg-[#111129]/60 p-10 rounded-2xl shadow-xl border border-white/10 backdrop-blur-xl">
        ...
        <p class="text-gray-400 mb-6 text-lg">
            Soft, sweet, and perfect with coffee — our daily baked glazed donut will delight your senses.
        </p>
        ...
        <form action="/checkout" method="POST" class="space-y-6">
            ...
            <!-- Hidden Product Name -->
            <input type="hidden" name="product" value="Glazed Donut">
            ...
            <p class="text-xl">
                Total: 
                <span id="totalPrice" class="text-purple-300 font-semibold">₱80</span>
            </p>
