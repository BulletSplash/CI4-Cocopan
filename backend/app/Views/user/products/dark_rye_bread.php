...
<section class="pt-32 pb-20 px-6">
    <div class="max-w-4xl mx-auto bg-[#111129]/60 p-10 rounded-2xl shadow-xl border border-white/10 backdrop-blur-xl">
        ...
        <p class="text-gray-400 mb-6 text-lg">
            Dense, flavorful, and crafted perfectly for toast lovers — baked daily in the void.
        </p>
        ...
        <form action="/checkout" method="POST" class="space-y-6">
            ...
            <!-- Hidden Product Name -->
            <input type="hidden" name="product" value="Dark Rye Bread">
            ...
            <p class="text-xl">
                Total: 
                <span id="totalPrice" class="text-purple-300 font-semibold">₱140</span>
            </p>
